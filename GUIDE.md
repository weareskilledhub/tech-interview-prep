...
- `mock_interviews/` → Amazon, Meta, Google, Microsoft coding mock interview çözümleri
...
- branch, commit, pull request gibi Git/GitHub çalışma düzenini öğrenmek
...
Problem açıklaması, örnek input-output, complexity beklentisi gibi içerikler öğretmen tarafından hazırlanır.
...
Süper. Aşağıya repo köküne koyabileceğin **tam `GUIDE.md`** metnini bırakıyorum.
...
GitHub üzerinden kendi branch'inizi `main` branch'e karşı PR olarak açın.
